...
var EditableDisplayArticle = /** @class */ (function (_super) {
    ...
    EditableDisplayArticle.prototype.footerHtml = function () {
        return "<div>\n        <span>\uD478\uD130</span>\n        <input value=\"".concat(this.article.getFooter(), "\" />\n    </div>");
    };
...
/* harmony import */ var _Template_Method_EditableDisplayArticle__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Template Method/EditableDisplayArticle */ "./src/Template Method/EditableDisplayArticle.ts");
/* harmony import */ var _Template_Method_SimpleDisplayArticle__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Template Method/SimpleDisplayArticle */ "./src/Template Method/SimpleDisplayArticle.ts");



var article = new _Article__WEBPACK_IMPORTED_MODULE_0__["default"]("제목123", ["컨텐츠1", "컨텐츠2", "컨텐츠3", "컨텐츠4"], "푸터123");
var display = new _Template_Method_SimpleDisplayArticle__WEBPACK_IMPORTED_MODULE_2__["default"](article);
...
document.querySelector(".edit-mode").addEventListener("change", function (event) {
    ...
    if (event.target.checked) {
        display = new _Template_Method_EditableDisplayArticle__WEBPACK_IMPORTED_MODULE_1__["default"](article);
    }
    else {
        display = new _Template_Method_SimpleDisplayArticle__WEBPACK_IMPORTED_MODULE_2__["default"](article);
    }
    document.querySelector(".content").innerHTML = display.displayHtml();
});
