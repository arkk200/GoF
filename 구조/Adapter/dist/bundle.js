...
/* harmony import */ var _Bear__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Bear */ "./src/Adapter/Bear.ts");
...
var BearAdapter = /** @class */ (function (_super) {
    ...
    BearAdapter.prototype.sound = function () {
        console.log("".concat(this.bear.name, ": ").concat(this.bear.roar()));
    };
    return BearAdapter;
}(_Animal__WEBPACK_IMPORTED_MODULE_0__["default"]));
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (BearAdapter);
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Adapter_Cat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Adapter/Cat */ "./src/Adapter/Cat.ts");
/* harmony import */ var _Adapter_Dog__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Adapter/Dog */ "./src/Adapter/Dog.ts");
/* harmony import */ var _Adapter_BearAdapter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Adapter/BearAdapter */ "./src/Adapter/BearAdapter.ts");
 ...
 */
list.push(new _Adapter_BearAdapter__WEBPACK_IMPORTED_MODULE_2__["default"]("bear1"));
list.forEach(function (animal) { return animal.sound(); });
